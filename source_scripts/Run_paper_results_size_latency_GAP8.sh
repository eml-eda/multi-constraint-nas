...
if [[ $_benchmark == "icl" ]]; then
    ...
    if [[ $_model == "Supernet" ]]; then
        _latency_target=( 3.79e+05 7.59e+05 1.14e+06 9.68e+05 1.94e+06 2.90e+06 1.18e+06 2.37e+06 3.55e+06 )
        _cd_ops=( 1.25e-05 1.41e-05 1.63e-05 1.34e-05 1.65e-05 2.17e-05 1.37e-05 1.77e-05 2.49e-05 )
    fi
...
if [[ $_benchmark == "vww" ]]; then
    ...
    if [[ $_model == "Supernet" ]]; then
        _latency_target=( 2.24e+05 4.48e+05 6.72e+05 4.71e+05 9.43e+05 1.41e+06 )
